...
The OLOUD ontology consists of two modules: [OLOUD-BASE](oloud-20160609.owl) and [OLOUD-TIME](oloud-time-20160609.owl). The former describes all the university related concepts, uses the prefix oloud, the latter provides the necessary classes and properties to describe course time data as recurring events, using the prefix otime. OLOUD also uses the [iLOC ontology](https://github.com/dsd-sztaki-hu/iLOC) for indoor navigation and indoor location description tasks.
